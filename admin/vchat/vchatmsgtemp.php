...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="vchat/addnewtemp.php<?php echo "?J=".$_GET["J"];?>" mask="true" target="dialog" width="400" height="260" rel="addneworder"><span>添加模板</span></a></li>
			<li><a class="edit" href="vchat/edittemp.php?tempid={templist}&<?php echo "J=".$_GET["J"];?>" target="dialog" mask="true"  width="400" height="260"><span>修改</span></a></li>
			<li><a class="delete" href="action/delete.php?action=vchattemp&tempid={templist}&<?php echo "J=".$_GET["J"];?>" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
	 ...
	 <?php 
			 ...
			 if(isset($_POST["search"])){
			     ...
			     $result=$db->tabledata($pageNum,$numPerPage,"uk_vchatmsgtemp","*","1=1 ".$sql." ","id");
